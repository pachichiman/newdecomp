...
const u16 gMetatiles_GeovaleTileset[] = INCBIN_U16("data/tilesets/secondary/geovale_tileset/metatiles.bin");
const u16 gMetatileAttributes_GeovaleTileset[] = INCBIN_U16("data/tilesets/secondary/geovale_tileset/metatile_attributes.bin");
