static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_GEOVALE_TOWN - 1] = {MAP_GROUP(GEOVALE_TOWN), MAP_NUM(GEOVALE_TOWN), 4, 19},
    [HEAL_LOCATION_LARIMAR_TOWN - 1] = {MAP_GROUP(LARIMAR_TOWN), MAP_NUM(LARIMAR_TOWN), 29, 4},
};
